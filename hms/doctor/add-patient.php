...
if(strlen($_SESSION['id'])==0) {
    ...
    if(isset($_POST['submit'])) {	
        ...
        $sql=mysqli_query($con,"insert into tblpatient(Docid,PatientName,PatientContno,PatientEmail,PatientGender,PatientAdd,PatientAge,PatientMedhis,statusName) values('$docid','$patname','$patcontact','$patemail','$gender','$pataddress','$patage','$medhis', '$statusName')");
		if($sql)
		{
...
<div class="form-group">
							...
							<select name="statusName" class="form-control" required="true">
																<option value="">Select Status</option>
<?php $ret=mysqli_query($con,"select * from tblstatus");
while($row=mysqli_fetch_array($ret))
{
?>
																<option value="<?php echo htmlentities($row['statusName']);?>">
																	<?php echo htmlentities($row['statusName']);?>
																</option>
																<?php } ?>
