...
<head>
    ...
    <title> HIV Tracking System  </title>
    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">HIVTS
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">HIV Tracking System</h5>
    ...
    <section id="about_us" class="about-us">
        <div class="row no-margin">
            ...
            <div class="col-sm-6 abut-yoiu">
                ...
                <p>The objectives of an HIV tracking system include surveillance of HIV prevalence and incidence, 
                    early detection and intervention to facilitate prompt diagnosis and treatment, monitoring treatment 
                    outcomes to ensure effective care, linkage to care for individuals diagnosed with HIV, evaluation of 
                    prevention programs to guide resource allocation, data analysis for research and policy development, 
                    and ensuring privacy and confidentiality of personal health information. These objectives aim to 
                    effectively monitor and respond to the spread of HIV, improve health outcomes, and inform evidence-based 
                    strategies for prevention, treatment, and support services.</p>
